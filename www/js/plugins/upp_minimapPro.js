...
( function() {
	...
	*/
	...
	Dummy_Window.prototype.update = function() {
		...
		if(this.drawType == 3){
			...
			this.contents.drawText("Контурный рисунок", 0, this.lineHeight()*4, this.contents.width, this.lineHeight());
			this.contents.drawText("Показатель качества мини-карты", 0, this.lineHeight()*5, this.contents.width, this.lineHeight());
			this.contents.drawText("HQ Рисунок", 0, this.lineHeight()*6, this.contents.width, this.lineHeight());
			this.contents.drawText("Рисунок иконок", 0, this.lineHeight()*7, this.contents.width, this.lineHeight());
			this.contents.drawText("Рисование маяка(мерцание)", 0, this.lineHeight()*8, this.contents.width, this.lineHeight());
			//Draw border
			...
			this.contents.drawText("Включено", this.contents.width-192, this.lineHeight()*4, 96, this.lineHeight(), 'center');
			
			this.changeTextColor(this.normalColor())
			if($gameSystem.mmData.drawBorder == null){this.changeTextColor(this.deathColor());}
			if($gameSystem.mmData.drawBorder == false){this.changeTextColor(this.systemColor());}
			this.contents.drawText("Выключено", this.contents.width-96, this.lineHeight()*4, 96, this.lineHeight(), 'center');
			...
			this.contents.drawText("Высокие", this.contents.width-192, this.lineHeight()*5, 96, this.lineHeight(), 'center');
			
			this.changeTextColor(this.normalColor())
			if($gameSystem.mmData.indicatorQuality == "Off"){this.changeTextColor(this.deathColor());}
			if($gameSystem.mmData.indicatorQuality == "Low"){this.changeTextColor(this.systemColor());}
			this.contents.drawText("Низкие", this.contents.width-96, this.lineHeight()*5, 96, this.lineHeight(), 'center');
			...
			this.contents.drawText("Включено", this.contents.width-192, this.lineHeight()*6, 96, this.lineHeight(), 'center');
			
			this.changeTextColor(this.normalColor())
			if($gameSystem.mmData.drawRegions == null){this.changeTextColor(this.deathColor());}
			if($gameSystem.mmData.drawRegions == false){this.changeTextColor(this.systemColor());}
			this.contents.drawText("Выключено", this.contents.width-96, this.lineHeight()*6, 96, this.lineHeight(), 'center');
			...
			this.contents.drawText("Включено", this.contents.width-192, this.lineHeight()*7, 96, this.lineHeight(), 'center');
			
			this.changeTextColor(this.normalColor())
			if($gameSystem.mmData.drawIcons == null){this.changeTextColor(this.deathColor());}
			if($gameSystem.mmData.drawIcons == false){this.changeTextColor(this.systemColor());}
			this.contents.drawText("Выключено", this.contents.width-96, this.lineHeight()*7, 96, this.lineHeight(), 'center');
			...
			this.contents.drawText("Включено", this.contents.width-192, this.lineHeight()*8, 96, this.lineHeight(), 'center');
			
			this.changeTextColor(this.normalColor())
			if($gameSystem.mmData.drawBeacons == null){this.changeTextColor(this.deathColor());}
			if($gameSystem.mmData.drawBeacons == false){this.changeTextColor(this.systemColor());}
			this.contents.drawText("Выключено", this.contents.width-96, this.lineHeight()*8, 96, this.lineHeight(), 'center');
	...
	Window_MmConfigMain.prototype.addMainCommands = function() {
		this.addCommand("Цвет 1", 'color');
		this.addCommand("Цвет 2", 'color2');
		this.addCommand("Расположение", 'location');
		this.addCommand("Качество карты", 'performance');
	...
	Window_MmQualityChoice.prototype.addMainCommands = function() {
		this.addCommand("Выключить", 'off');
		this.addCommand("Низкие", 'low');
		this.addCommand("Средние", 'medium');
		this.addCommand("Высокие", 'high');
		this.addCommand("Назад", 'back');
	}
	...
	Window_mmColorSelector.prototype.addMainCommands = function() {
		this.addCommand("Непроходимый Красный", 'red');
		this.addCommand("Непроходимый Зеленый", 'green');
		this.addCommand("Непроходимый Синий", 'blue');
		this.addCommand("Непроходимый Alpha", 'opacity');
		this.addCommand("Проходимый Красный", 'red2');
		this.addCommand("Проходимый Зеленый", 'green2');
		this.addCommand("Проходимый Синий", 'blue2');
		this.addCommand("Проходимый Alpha", 'opacity2');
		this.addCommand("По умолчанию", 'default');
	...
	Window_mmColorSelector2.prototype.addMainCommands = function() {
		this.addCommand("Граница-Красный", 'red');
		this.addCommand("Граница-Зеленый", 'green');
		this.addCommand("Граница-Синий", 'blue');
		this.addCommand("Граница-Альфа", 'opacity');
		this.addCommand("Игрок-Красный", 'red2');
		this.addCommand("Игрок-Зеленый", 'green2');
		this.addCommand("Игрок-Синий", 'blue2');
		this.addCommand("Игрок-Альфа", 'opacity2');
		this.addCommand("По умолчанию", 'default');
		this.addCommand("Назад", 'cancel');
	}
	...
	Window_mmLocationSelector.prototype.addMainCommands = function() {
		this.addCommand("Настроить мини-карту X/Y", 'map');
		this.addCommand("Настроить Name X/Y", 'name');
		this.addCommand("По умолчанию", 'default');
		this.addCommand("Назад", 'cancel');
	}
	...
	Scene_mmSettings.prototype.update = function(){
		...
		if(this.foc == 0)
		{
			switch(this.mainChoice._index){
				case 0:
					$gameSystem.mmData.helpMsg = "Настройте цвет мини-карты.";
				...
				case 2:
					$gameSystem.mmData.helpMsg = "Настройте расположение мини-карты.";
					this.colorChoice.hide();
					this.colorChoice2.hide();
				...
				case 3:
					$gameSystem.mmData.helpMsg = "Настройте производительность мини-карты.";
					this.colorChoice.hide();
					this.colorChoice2.hide();
					this.locationChoice.hide();
				...
				case 4:
					$gameSystem.mmData.helpMsg = "Выход из настройки мини-карты";
					this.colorChoice.hide();
					this.colorChoice2.hide();
					this.locationChoice.hide();
					this.qualityWindow.hide();
		...
		if(this.foc == 1)
		{
			switch(this.colorChoice._index){
				case 0: case 4:
					$gameSystem.mmData.helpMsg = "Красный цвет (стрелки влево/вправо для регулировки)";
				...
				case 1: case 5:
					$gameSystem.mmData.helpMsg = "Зеленый цвет (стрелки влево/вправо для регулировки)";
					if(Input.isRepeated('left') || Input.isPressed("pageup"))
					{
				...
				case 2: case 6:
					$gameSystem.mmData.helpMsg = "Синий цвет (стрелки влево/вправо для регулировки)";
					if(Input.isRepeated('left') || Input.isPressed("pageup"))
					{
				...
				case 3: case 7:
					$gameSystem.mmData.helpMsg = "Альфа-значение (стрелки влево/вправо для регулировки)";
					if(Input.isRepeated('left') || Input.isPressed("pageup"))
					{
				...
				case 8:
					$gameSystem.mmData.helpMsg = "Восстановить все обратно к значениям по умолчанию.";
				break;
				case 9:
					$gameSystem.mmData.helpMsg = "Вернитесь, чтобы выбрать настройку.";
				break;
			}
		}
		...
		if(this.foc == 3)
		{
			switch(this.locationChoice._index){
				case 0:
					$gameSystem.mmData.helpMsg = "Расположение миникарты на экране.";
				break;
				case 1:
					$gameSystem.mmData.helpMsg = "Расположение названия карты на экране.";
				break;
				case 2:
					$gameSystem.mmData.helpMsg = "Восстановить все обратно к значениям по умолчанию.";
				break;
	...
	*/
	...
	Window_Options.prototype.addGeneralOptions = function() {
		...
		this.addCommand("Настройки мини-карты", 'mmOptions');
	}
