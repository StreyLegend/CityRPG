...
# e utilizar o comando de tecla dos scripts normalmente que sao.

# Esse e como um gatilho, ao apertar ele indica que foi apertado 
# uma vez, e so volta a retornar verdadeiro caso seja solto a tecla
# e pressionado novamente
# Input.trigger?(tecla)

# Esse e o identico ao dos eventos, ele indica se a tecla esta pressionada. 
# Input.press?(tecla)

# Esse e o utilizado nas lojas e menus, ele indica verdadeiro no momento
# que se pressiona, e indica falso ate um certo tempo, depois volta a indicar
# verdadeiro.
# Input.repeat?(tecla)

# Para utilizar e bem simples, basta olhar a tabela abaixo e colocar
# um Key:: na frente, por exemplo
# Input.trigger?(Key::F)   => indica se foi pressionado a tecla F
# Input.press?(Key::Ctrl)  => indica se o Ctrl esta pressionado
# Input.repeat?(Key::K6)   => indica se o numerador 6 foi pressionado
# e fara a verificacao de quanto tempo ele esta pressionado.

# Coloque esse codigo nas Condicoes dos eventos, 4? aba das condicoes, Script:
...
Y = 0x59 #Tecla Y 
Z = 0x5A #Tecla Z 
Mouse1 = 0x01 #Botao esquerdo do mouse 
Mouse2 = 0x02 #Botao direito do mouse 
Cancel = 0x03 #Cancelar/interromper processamento 
Mousewheel = 0x04 #Botao do meio do mouse (em um mouse de tres botoes)  
Mouse3 = 0x05 #Windows 2000/XP: Botao X1 do mouse 
Mouse4 = 0x06 #Windows 2000/XP: Botao X2 do mouse 
...
Esc = 0x1B #Tecla ESC 
Space = 0x20 #Tecla SPACEBAR (Espaco) 
...
Num0 = 0x60 #Tecla 0 (T. numerico) 
Num1 = 0x61 #Tecla 1 (T. numerico) 
Num2 = 0x62 #Tecla 2 (T. numerico) 
Num3 = 0x63 #Tecla 3 (T. numerico) 
Num4 = 0x64 #Tecla 4 (T. numerico) 
Num5 = 0x65 #Tecla 5 (T. numerico) 
Num6 = 0x66 #Tecla 6 (T. numerico) 
Num7 = 0x67 #Tecla 7 (T. numerico) 
Num8 = 0x68 #Tecla 8 (T. numerico) 
Num9 = 0x69 #Tecla 9 (T. numerico) 
